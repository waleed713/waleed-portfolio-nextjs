...
function FiverrIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M12.5 6.5h4v2h-2.3c-.7 0-1.2.5-1.2 1.2v.8h3v2h-3v6h-2.3v-6H9v-2h1.7v-.9c0-1.9 1.4-3.1 3.3-3.1H12.5Z"
        fill="#fff"
      />
      <circle cx="6.7" cy="7.3" r="1.3" fill="#fff" />
      <path d="M5.5 10.5h2.3v7H5.5v-7Z" fill="#fff" />
    </svg>
  );
}
